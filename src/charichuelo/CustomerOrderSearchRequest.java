 ...
 *       &lt;sequence>
 *         &lt;element name="cor_order_id" type="{http://www.w3.org/2001/XMLSchema}int" maxOccurs="unbounded"/>
...
public class CustomerOrderSearchRequest {
    ...
    @XmlElement(name = "cor_order_id", type = Integer.class)
    protected List<Integer> corOrderId;
     ...
     * This is why there is not a <CODE>set</CODE> method for the corOrderId property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCorOrderId().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Integer> getCorOrderId() {
        if (corOrderId == null) {
            corOrderId = new ArrayList<Integer>();
        }
        return this.corOrderId;
    }
